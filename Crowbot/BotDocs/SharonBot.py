...
async def on_message(message):
    ...
    if message.content.startswith(invoker + '!help'):
        await client.send_message(message.channel,
        "```A bot designed for Haikus\nCommands available to everyone:\ncaw!hello: H E L L O\ncaw!haiku: be treated to a dandy haiku made from the txt files\ncaw!submit: submit your own stanzas for review\ncaw!help: shows the help page\ncaw!credits: shows where credit is due\ncommands available to admins (Role Manegers)\ncaw!view: allows you to look at the available stanzas and submitions\n```")
